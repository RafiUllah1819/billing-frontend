...
const SupplierLedgerDetailPage = () => {
  ...
  const fetchLedger = async () => {
    try {
      setLoading(true);
      setError('');
      const response = await api.get(`/ledger/suppliers/${supplierId}`);
      setLedgerData(response.data.data);
    } catch (err) {
      setError(err?.response?.data?.message || 'Failed to load supplier ledger');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return <div className="page-loading">Loading supplier ledger...</div>;
  }
  ...
  const { supplier, summary, entries } = ledgerData;
  ...
  exportToCsv(`supplier-ledger-${supplier.supplier_code}`, exportRows);
};
    ...
    <div className="ledger-page">
      <div className="page-header-row no-print">
        <div className="page-header">
          ...
          <p>Full statement and running balance for this supplier</p>
        </div>

              <div className="detail-header-actions">
                  <Link
                      to={`/payments/supplier-payment?supplier_id=${supplier.id}`}
                  ...
                  <Link to="/ledger/suppliers" className="secondary-header-btn link-btn">
                      Back
                  </Link>
      ...
      <div className="ledger-print-sheet print-area">
        <div className="print-header">
          <div>
            ...
            <p className="print-company-meta">Supplier Ledger Statement</p>
...
export default SupplierLedgerDetailPage;